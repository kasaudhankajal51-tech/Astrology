      ...
      <aside className="sidebar">
        <div className="sb-head">
          <div className="sb-logo">
            ...
            <div className="sb-logo-text">{stats?.siteName || 'DS Institute'} <em>Pro</em></div>
          </div>
        ...
        <nav className="sb-nav" onClick={() => setMobileMenuOpen(false)}>
          ...
          <div className="sb-group">
            ...
            <SidebarItem id="leads" filter="Course" icon="fa-graduation-cap" label="Live Course Enrollments" />
            <SidebarItem id="leads" filter="Course-Inquiry" icon="fa-question-circle" label="Course Enquiries" />
          ...
          {activeTab === 'dashboard' && (
            <div className="dash-home">
              <div className="dash-greeting mb-4">
                <h2>Welcome DS Institute Admin</h2>
