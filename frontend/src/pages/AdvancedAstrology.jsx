    ...
    <section className="course-modern">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 text-lg-start text-center">
              ...
              <h1 className="hero-title" data-aos="fade-up" data-aos-delay="200">
                ...
                <span className="gradient-text">Advanced Astrology</span>
              </h1>
            ...
            <div className="col-lg-6 mt-lg-0 mt-5">
              <div className="hero-visual-center" data-aos="zoom-in" data-aos-delay="600">
                <div className="main-image-wrapper">
                  <img src="/images/horocurty.jpg" alt="Course" />
      ...
      <div className="timeline-section">
        <div className="container">
          ...
          <p className="section-sub">6 stages from intermediate to advanced mastery</p>
        ...
        <div className="container">
          ...
          <div className="includes-grid">
            <div className="include-card premium">
              ...
              <span className="ic-badge">30-35 Sessions</span>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-5">
              <div className="instructor-image">
                <img src="/images/spiritual-man-india-traditional-clothing-39495501.jpg" alt="Instructor" />
          ...
          <div className="cta-box">
            ...
            <div className="cta-price-row">
              <div className="cp-left">
                <span className="cp-current">₹1,299</span>
                <span className="cp-old">₹4,999</span>
                <span className="cp-save">Save 74%</span>
              </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                ...
                <div className="fee-info">
                  <p><strong>Course Fee:</strong> <span className="fee-amount">₹1,299</span></p>
                  <p className="text-muted">Was ₹4,999 - Save 74% today</p>
                </div>
              </div>
