...
function AdvancedAstrology() {
  ...
  return (
    <section className="course-light-advanced">
      {/* Full Width Hero */}
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 text-lg-start text-center">
              <div className="hero-infographic-light" data-aos="fade-up">
                <img src="/images/advanced_info.png" alt="Advanced Astrology" />
              </div>
              ...
              <h1 className="hero-title-light" data-aos="fade-up" data-aos-delay="200">
                <span>Master</span>
                <span className="gradient-text-light">Advanced Astrology</span>
              </h1>
              <p className="hero-desc-light" data-aos="fade-up" data-aos-delay="300">
                Take your astrological knowledge to the next level. Learn divisional charts, 
                advanced dashas, and professional prediction techniques.
              </p>
              ...
              <div className="hero-cta-row-light mt-4" data-aos="fade-up" data-aos-delay="500">
                <button className="btn-primary-light" onClick={() => setShowModal(true)}>
                  <span>Join Now ₹1,299</span>
                  <small>was ₹4,999</small>
                </button>
            ...
            <div className="col-lg-6 mt-lg-0 mt-5">
              <div className="hero-visual-center-light" data-aos="zoom-in" data-aos-delay="600">
                <div className="main-image-wrapper-light">
                  <img src="/images/horocurty.jpg" alt="Advanced Astrology Course" />
      ...
      <div className="timeline-section-light">
        <div className="container">
          ...
          <p className="section-sub-light">6 stages from intermediate to advanced mastery</p>
        ...
        <div className="container">
          ...
          <div className="includes-grid-light">
            <div className="include-card-light premium">
              ...
              <span className="ic-badge-light">30-35 Sessions</span>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-5">
              <div className="instructor-image-light">
                <img src="/images/spiritual-man-india-traditional-clothing-39495501.jpg" alt="Guru Devanand Ji" />
                <div className="exp-badge-light">20+ Years Experience</div>
              </div>
            </div>
            <div className="col-lg-7">
              <div className="instructor-info-light">
                <span className="ii-label-light">Your Guide</span>
                <h2>Guru Devanand Ji</h2>
                ...
                <div className="ii-stats-light">
                  <div><strong>5,000+</strong><span>Students Taught</span></div>
                  <div><strong>20+</strong><span>Years Experience</span></div>
                  <div><strong>4</strong><span>Books Authored</span></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="final-cta-light">
        <div className="container">
          <div className="cta-box-light">
            <h2>Ready to Master Advanced Astrology?</h2>
            <p>Join 2,000+ students on this transformative journey</p>
            <div className="cta-price-row-light">
              <div className="cp-left-light">
                <span className="cp-current-light">₹1,299</span>
                <span className="cp-old-light">₹4,999</span>
                <span className="cp-save-light">Save 74%</span>
              </div>
        ...
        <div className="modal-overlay-light" onClick={() => setShowModal(false)}>
          <div className="modal-content-light" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header-light">
              <h4>Enroll in Advanced Astrology</h4>
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body-light">
                ...
                <div className="form-group-light">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                  >
                    <option value="intermediate">Intermediate - Know basics well</option>
                    <option value="advanced">Advanced - Have done some predictions</option>
                    <option value="expert">Expert - Looking for mastery</option>
                  </select>
                </div>
                <div className="fee-info-light">
                  <p><strong>Course Fee:</strong> <span className="fee-amount-light">₹1,299</span></p>
                  <p className="text-muted-light">Was ₹4,999 - Save 74% today</p>
                </div>
              </div>
              <div className="modal-footer-light">
                ...
                <button type="submit" className="btn-payment-light" onClick={handlePayment}>
                  <i className="fas fa-lock"></i> Pay ₹1,299 & Enroll
                </button>
              </div>
            </form>
          </div>
      ...
      <style>{`
        /* ============================================
           LIGHT THEME - ADVANCED ASTROLOGY COURSE
           Same styling as Vedic Course for consistency
           ============================================ */
        
        .course-light-advanced {
