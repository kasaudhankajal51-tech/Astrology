        ...
        <div className="container">
          ...
          <div className="includes-grid">
            <div className="include-card premium">
              ...
              <span className="ic-badge">50+ Sessions</span>
            </div>
          ...
          <div className="cta-box">
            ...
            <div className="cta-price-row">
              <div className="cp-left">
                <span className="cp-current">₹2,499</span>
                <span className="cp-old">₹9,999</span>
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                ...
                <div className="fee-info">
                  <p><strong>Program Fee:</strong> <span className="fee-amount">₹2,499</span></p>
                  <p className="text-muted">Was ₹9,999 - Save 75% today</p>
                </div>
              </div>
