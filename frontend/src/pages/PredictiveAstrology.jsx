          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              ...
              <h1 className="hero-title">
                Master
                <span className="gradient-text">Predictive Astrology</span>
              </h1>
              <p className="hero-desc">
                Learn the art of accurate prediction. Master timing techniques, event forecasting, 
                and professional consultation methods.
              </p>
