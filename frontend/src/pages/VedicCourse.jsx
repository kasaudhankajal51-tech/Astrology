          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              ...
              <h1 className="hero-title">
                Become a Certified
                <span className="gradient-text">Vedic Astrologer</span>
              </h1>
              <p className="hero-desc">
                Master the ancient science of Jyotish. From reading birth charts to 
                making accurate predictions - transform your passion into expertise.
              </p>
              ...
              <div className="hero-cta-row">
                <button className="btn-primary-hero" onClick={() => setShowModal(true)}>
                  <span>Join Now ₹699</span>
                  <small>was ₹2,999</small>
                </button>
            ...
            <div className="col-lg-6">
              <div className="hero-visual">
                <div className="main-image-wrapper">
                  <img src="/images/moon.jpg" alt="Vedic Astrology Course" />
        ...
        <div className="container">
          ...
          <div className="includes-grid">
            <div className="include-card premium">
              ...
              <span className="ic-badge">25-30 Sessions</span>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-7">
              <div className="instructor-info">
                ...
                <p className="ii-desc">
                  A renowned Vedic scholar with 12+ years of experience in traditional astrology. 
          ...
          <div className="cta-box">
            ...
            <div className="cta-price-row">
              <div className="cp-left">
                <span className="cp-current">₹699</span>
                <span className="cp-old">₹2,999</span>
                <span className="cp-save">Save 77%</span>
              </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                ...
                <div className="fee-info">
                  <p><strong>Course Fee:</strong> <span className="fee-amount">₹699</span></p>
                  <p className="text-muted">Limited time offer</p>
                </div>
              </div>
